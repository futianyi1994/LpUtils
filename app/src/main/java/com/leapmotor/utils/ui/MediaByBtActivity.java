...
public class MediaByBtActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onDestroy() {
        ...
        MediaByBtManager.getInstance().unBindService(this, conn, seekListener, playStateListener);
    }
                    ...
                    ApiByBtInterface
                            ...
                            .getHisAlbumsByUid(iMediaAidlInterface, Constants.XMLY_FIRST_OFFSET, 4, -1, new HttpCallback<HistoryPlayRecordFullPage>() {
                                ...
                                public void onSuccess(HistoryPlayRecordFullPage historyPlayRecordFullPage) {
                                    ...
                                    ApiByBtInterface.playXmlyHis(iMediaAidlInterface, historyPlayRecordFullBean);
                                }
                            });
                } else if (id == R.id.getMediaBody) {
                    MediaBody mediaBody = ApiByBtInterface.getInstance().getMediaBody(iMediaAidlInterface);
                    ...
                    seekListener = new SeekListener.Stub() {
                        ...
                        public void onSeek(SeekBody seekBody) throws RemoteException {
                            ...
                            ThreadUtils.runOnUiThread(() -> {
                                MediaByBtActivity.this.seekBody = seekBody;
                ...
                if (playStateListener == null) {
                    playStateListener = new PlayStateListener.Stub() {
                        ...
                        public void onState(MediaBody mediaBody) throws RemoteException {
                            MediaByBtActivity.this.mediaBody = mediaBody;
                            ThreadUtils.runOnUiThread(() -> {
    ...
    private void setPlayMode(IMediaByBtAidlInterface iMediaAidlInterface) {
        try {
