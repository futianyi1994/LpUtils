package com.leapmotor.lputils.animation;
...
public class OptAnimationLoader {
    ...
    public static Animation loadAnimation(Context context, int id) throws Resources.NotFoundException {
        ...
        try {
            ...
            Resources.NotFoundException rnf = new Resources.NotFoundException("Can't load animation resource ID #0x" + Integer.toHexString(id), ex);
            throw rnf;
